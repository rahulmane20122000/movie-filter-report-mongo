...
const getAllMovies = (limit, page, sortBy, order, searchValue, field) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const movies = yield movie_repo_1.default.getAll(limit, page, sortBy, order, searchValue, field);
        const count = yield movie_repo_1.default.getCount();
        return { count: movies.length, previousPage: page != 0, nextPage: page + 1 < Math.floor(count[0].count / limit), movies: movies };
    }
    catch (error) {
        throw error;
